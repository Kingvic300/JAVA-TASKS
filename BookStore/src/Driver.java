...
public class Driver {
    ...
    private static void loginMenu(){
        ...
        String options = """
                ...
                """;
        display(options);
        loginMainMenu(input("Enter an option"));
    }
    private static void loginMainMenu(String userInput){
        switch (userInput) {
            case "1":
                loginPage();
                loginMenu();
    ...
    private static void registerPage() {
        ...
        Customer customer = new Customer(username,shoppingCart);
        int iD = customer.getID();
        iDs.add(iD);
        display("Your id is  "+ iD);
        display("you have registered successfully");
    }
    ...
    public static void loginPage(){
        ...
        try {
            ...
            display("Invalid ID. Please try again.");
            loginPage();
        }
        ...
        if (isIdValid) {
            ...
            display("Invalid ID, Please register first.");
            loginMenu();
        }
    }
    ...
    private static void addToCart() {
        ...
        try {
            ...
            boolean found = false;
            for (Book book : books) {
                if (book.getTitle().equalsIgnoreCase(title) && book.getPrices().equals(price) && book.getAuthor().equalsIgnoreCase(author)) {
                    found = true;
